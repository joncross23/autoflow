...
export const windowsTheme: ThemeDefinition = {
  ...
  accents: {
    ...
    sky: {
      ...
      primaryHover: "#3AACF0",
      primaryMuted: "#0A3A4D",
      primaryGradient: "linear-gradient(135deg, #4CC2FF 0%, #3AACF0 100%)",
    },
    teal: {
      primary: "#00B294",
      primaryHover: "#009D80",
      primaryMuted: "#0A3D35",
      primaryGradient: "linear-gradient(135deg, #00B294 0%, #009D80 100%)",
    },
    blue: {
      primary: "#0078D4",
      primaryHover: "#005A9E",
    ...
    coral: {
      ...
      primaryHover: "#F77C35",
      primaryMuted: "#4D2A0F",
      primaryGradient: "linear-gradient(135deg, #FF8C42 0%, #F77C35 100%)",
    },
    rose: {
      primary: "#E3008C",
      primaryHover: "#C4007A",
