...
export async function createResponse(
  ...
  // Insert without SELECT to avoid RLS issues (anonymous users can INSERT but not SELECT)
  ...
  // Return a minimal response object (we can't SELECT it back due to RLS)
  // The API route doesn't actually use this return value except for the ID
  return {
    id: "", // Will be generated by database but we can't retrieve it
    questionnaire_id: questionnaireId,
    questions_snapshot: questionsSnapshot,
    answers: validated.answers,
    respondent_email: validated.respondent_email ?? null,
