-- ============================================
-- AutoFlow - V1.3 Rich Cards Migration (SAFE)
-- Version: 1.3.0
-- ============================================
...
DROP POLICY IF EXISTS "Users can view labels on their ideas" ON idea_labels;
DROP POLICY IF EXISTS "Users can add labels to their ideas" ON idea_labels;
DROP POLICY IF EXISTS "Users can remove labels from their ideas" ON idea_labels;

DROP POLICY IF EXISTS "Users can view labels on their tasks" ON task_labels;
DROP POLICY IF EXISTS "Users can add labels to their tasks" ON task_labels;
DROP POLICY IF EXISTS "Users can remove labels from their tasks" ON task_labels;
...
DROP POLICY IF EXISTS "Users can view links on their items" ON links;
DROP POLICY IF EXISTS "Users can create links on their items" ON links;
DROP POLICY IF EXISTS "Users can update their links" ON links;
DROP POLICY IF EXISTS "Users can delete links on their items" ON links;
